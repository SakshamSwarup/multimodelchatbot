...
export function MessageInput({
      ...
      props.setFiles((currentFiles) => {
        ...
        if (supportedFiles.length !== files.length) {
          ...
          const unsupportedNames = unsupportedFiles
            ...
            .join(", ");
          alert(
            `The following files are not supported: ${unsupportedNames}\n\nSupported formats: Text (.txt), Markdown (.md), CSV (.csv), PDF (.pdf)`
          );
        }
  ...
  return (
    ...
    >
      ...
      <div className="absoulte flex w-full items-center space-x-2 sticky bottom-0">
...
function showFileUploadDialog() {
  ...
  input.type = "file";
  input.multiple = true;
  input.accept = ".txt,.md,.csv,.pdf,text/*,application/pdf";
  input.click();
  ...
  return new Promise<File[] | null>((resolve) => {
    input.onchange = (e) => {
      ...
      if (files) {
        ...
        resolve(supportedFiles.length > 0 ? supportedFiles : null);
        return;
      }
