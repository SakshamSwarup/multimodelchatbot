...
import { FileIcon, X, FileSpreadsheet, FileText } from "lucide-react";
...
export const FilePreview = React.forwardRef<HTMLDivElement, FilePreviewProps>(
  (props, ref) => {
    ...
    if (
      ...
      props.file.type === "application/vnd.ms-excel" ||
      props.file.name.toLowerCase().endsWith(".xlsx") ||
      props.file.name.toLowerCase().endsWith(".xls")
    ) {
      return <ExcelFilePreview {...props} ref={ref} />;
    }
    ...
    if (
      ...
      return <WordFilePreview {...props} ref={ref} />;
    }
...
const ExcelFilePreview = React.forwardRef<HTMLDivElement, FilePreviewProps>(
  ({ file, onRemove }, ref) => {
    return (
      <motion.div
        ref={ref}
...
ExcelFilePreview.displayName = "ExcelFilePreview";
...
const WordFilePreview = React.forwardRef<HTMLDivElement, FilePreviewProps>(
  ({ file, onRemove }, ref) => {
    return (
      <motion.div
        ref={ref}
...
WordFilePreview.displayName = "WordFilePreview";
